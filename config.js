module.exports = {
    sqlConnectionString: "Data Source=104.211.182.161;Database=ATSPrelive3;Integrated Security=false;User ID=ganit;Password=GCVhvj534cfg;MultipleActiveResultSets=True", // Correct connection string format.
